...
robot.move();
// 30
const School_1 = require("./bai30/School");
const Student_1 = require("./bai30/Student");
const Teacher_1 = require("./bai30/Teacher");
const school = new School_1.School();
const teacher1 = new Teacher_1.Teacher("Alice", 35, "Math");
const teacher2 = new Teacher_1.Teacher("Bob", 40, "Physics");
const student1 = new Student_1.Student("Charlie", 15, "10th");
const student2 = new Student_1.Student("Daisy", 16, "11th");
